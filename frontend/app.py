...
with st.sidebar:
    ...
    st.markdown("---")
    # Developer Console Link (Dynamic for Local vs. Monolith deployment)
    console_url = "/dev-console" if (os.getenv("RUN_MONOLITH", "false").lower() == "true" or "localhost:8000" not in API_BASE_URL) else "http://localhost:8000/dev-console"
